...
class RDRecordDetailAdapter(
    private val details: List<RDRecordDetail>,
    private val onDelete: (Int) -> Unit
) : RecyclerView.Adapter<RDRecordDetailAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(private val binding: ItemSaleDetailBinding) :
        ...
        fun bind(detail: RDRecordDetail, position: Int) {
